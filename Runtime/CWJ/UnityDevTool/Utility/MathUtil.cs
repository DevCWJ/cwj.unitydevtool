...
namespace CWJ
{
    ...
    {
        private readonly static float[] _TargetValues = new float[] { 0.5f, 0f, 1.0f, -1.0f, -0.5f };
        private readonly static double[] _TargetValuesDbl = new double[] { 0.5f, 0f, 1.0f, -1.0f, -0.5f };

        public static float RoundToFloatingValue(this float value)
        {
            foreach (float target in _TargetValues)
            {
        ...
        public static double RoundToFloatingValue(this double value)
        {
            foreach (double target in _TargetValuesDbl)
            {
                if (value == target) return value;
                if (Mathf.Abs((float)(value - target)) < EPSILON)
                    return target;
            }

            return value;
        }
        //public static float GetFloatingSafeNumber(this float num)
        //{
        ...
        //    return num;
        //}
        public static Vector2 RoundToFloatingValue(this Vector2 v)
        {
            return new Vector2(RoundToFloatingValue(v.x), RoundToFloatingValue(v.y));
        }

        public static Vector3 RoundToFloatingValue(this Vector3 v)
        {
            return new Vector3(RoundToFloatingValue(v.x), RoundToFloatingValue(v.y), RoundToFloatingValue(v.z));
        }
