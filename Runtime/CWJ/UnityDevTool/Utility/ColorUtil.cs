...
namespace CWJ
{
	public class ColorUtil
	{
		...
		/// <returns></returns>
		/// <remarks>与<see cref="ColorUtility"/>The results are consistent，and can be used during initialization</remarks>
...
namespace UnityEngine
{
	...
	public partial struct HexColor
	{
		...
		{
			if (ColorUtil.TryParseHtmlString2Color32(c.hexCode, out Color32 color))
			{
				return color;
			}
		...
		{
			if (ColorUtil.TryParseHtmlString(c.hexCode, out Color color))
			{
				return color;
			}
		...
		{
			//In order to ensure that individual files are available elsewhere.
...
#region CommonColors
	...
	public partial struct HexColor
	{
		...
		public static void DebugLogColor(string str = "Console text color")
		{
	...
	{
		public static readonly Color deepRed = HexColor.DeepRed;
		public static readonly Color bloodRed = HexColor.AlizarinCrimson;
		public static readonly Color rose = HexColor.DogwoodRose;
		public static readonly Color lightRed = HexColor.CGRed;

		public static readonly Color darkGreen = HexColor.DeepGreen;
		public static readonly Color lightGreen = HexColor.ForestGreenWeb;

		public static readonly Color darkBlue = HexColor.EgyptianBlue;
		public static readonly Color lightBlue = HexColor.FrenchBlue;

		public static readonly Color orange = HexColor.AlloyOrange;
		public static readonly Color lightBrown = HexColor.FuzzyWuzzy;

		public static readonly Color denim = HexColor.Denim;
		public static readonly Color darkSpringGreen = HexColor.DarkSpringGreen;
	}
}

#if UNITY_EDITOR

namespace UnityEditor.CWJ
{
	using global::CWJ;
	using UnityEditor;
